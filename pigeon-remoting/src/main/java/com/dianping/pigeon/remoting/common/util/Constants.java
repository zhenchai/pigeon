...
public final class Constants {
	...
	public static final int getChannelPoolInitialSize() {
		return ConfigManagerLoader.getConfigManager().getIntValue(KEY_CHANNEL_POOL_INITIAL_SIZE,
				DEFAULT_CHANNEL_POOL_INITIAL_SIZE);
	}

	public static final int getChannelPoolNormalSize() {
		return ConfigManagerLoader.getConfigManager().getIntValue(KEY_CHANNEL_POOL_NORMAL_SIZE,
				DEFAULT_CHANNEL_POOL_NORMAL_SIZE);
	}

	public static final int getChannelPoolMaxActive() {
		return ConfigManagerLoader.getConfigManager().getIntValue(KEY_CHANNEL_POOL_MAX_ACTIVE,
				DEFAULT_CHANNEL_POOL_MAX_ACTIVE);
	}

	public static final int getChannelPoolMaxWait() {
		return ConfigManagerLoader.getConfigManager().getIntValue(KEY_CHANNEL_POOL_MAX_WAIT,
				DEFAULT_CHANNEL_POOL_MAX_WAIT);
	}

	public static final int getChannelPoolTimeBetweenCheckerMillis() {
		return ConfigManagerLoader.getConfigManager().getIntValue(KEY_CHANNEL_POOL_TIME_BETWEEN_CHECKER_MILLIS,
				DEFAULT_CHANNEL_POOL_TIME_BETWEEN_CHECKER_MILLIS);
	}

	public static final boolean getInvokerHeartbeatEnable() {
		return ConfigManagerLoader.getConfigManager().getBooleanValue(KEY_INVOKER_HEARTBEAT_ENABLE,
				DEFAULT_INVOKER_HEARTBEAT_ENABLE);
	}

	public static final int getDefaultInvokerChannelDeadthreshold() {
		return ConfigManagerLoader.getConfigManager().getIntValue(KEY_INVOKER_CHANNEL_DEADTHRESHOLD,
				DEFAULT_INVOKER_CHANNEL_DEADTHRESHOLD);
	}

	public static final int getDefaultInvokerClientDeadthreshold() {
		return ConfigManagerLoader.getConfigManager().getIntValue(KEY_HEARTBEAT_DEADTHRESHOLD,
				DEFAULT_HEARTBEAT_DEADTHRESHOLD);
	}

	public static final int getInvokerHeartbeatTimeout() {
		return ConfigManagerLoader.getConfigManager().getIntValue(KEY_HEARTBEAT_TIMEOUT, DEFAULT_HEARTBEAT_TIMEOUT);
	}

	public static final int getInvokerHeartbeatInterval() {
		return ConfigManagerLoader.getConfigManager().getIntValue(KEY_HEARTBEAT_INTERVAL, DEFAULT_HEARTBEAT_INTERVAL);
	}
